                  ...
                  <div className="pt-3 border-t border-amber-300">
                    <div className="flex items-center gap-2 mb-2">
                      <Badge className={referrerLevel === 2 ? "bg-amber-500 text-white" : "bg-blue-500 text-white"}>
                        {referrerLevel === 2 ? "⭐ Nível 2 - Premium" : "Nível 1"}
                      </Badge>
                    </div>
              ...
              <CardContent>
                <div className="text-center mb-4">
                  ...
                  <Badge className={referrerLevel === 2 ? "bg-amber-500 text-white mt-2" : "bg-blue-500 text-white mt-2"}>
                    {referrerLevel === 2 ? "⭐ Nível Premium" : "Nível Inicial"}
                  </Badge>
                </div>
                {referrerLevel === 1 && totalConversions === 1 && (
                  <Alert className="bg-amber-50 border-amber-300">
                    ...
                    <AlertDescription className="text-amber-800 text-xs">
                      Mais 1 indicação fechada e você sobe para Nível 2 (R$ 150 por indicação)!
                    </AlertDescription>
                  </Alert>
                )}
              </CardContent>
            ...
            <Card className="border-blue-200 bg-blue-50">
              ...
              <CardContent className="text-sm text-blue-900 space-y-2">
                ...
                <div className="mt-4 pt-4 border-t border-blue-300">
                  ...
                  <p className="text-xs">• <strong>Nível 1:</strong> R$ 100/indicação</p>
                  <p className="text-xs">• <strong>Nível 2:</strong> R$ 150/indicação (após 2 fechadas)</p>
                </div>
              </CardContent>
            </Card>
