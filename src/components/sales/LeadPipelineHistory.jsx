...
const STAGES = [
  { id: 'novo', label: 'Novo', color: 'bg-gray-500', icon: Clock },
  { id: 'abordado', label: 'Abordado', color: 'bg-blue-500', icon: Check },
  { id: 'qualificado', label: 'Qualificado', color: 'bg-purple-500', icon: Check },
...
export default function LeadPipelineHistory({ lead, onStageChange }) {
  ...
  return (
    <div className="relative">
      {/* 🆕 LAYOUT HORIZONTAL INTERATIVO - COM PADDING PARA NÃO CORTAR */}
        ...
        {STAGES.map((stage, index) => {
          ...
          return (
            <React.Fragment key={stage.id}>
              {/* Stage Card - CLICÁVEL - COM MARGIN PARA NÃO CORTAR O RING */}
              <div 
                className={`flex-shrink-0 w-40 transition-all ${
                  isCurrent 
                    ? 'ring-4 ring-blue-500 ring-offset-2 scale-105 my-1' 
                    : 'my-1'
                } ${
                  isClickable 
              ...
              >
                <div className={`rounded-lg border-2 p-3 transition-all ${
                  isCompleted 
                    ...
                    : isCurrent
                    ? 'border-blue-500 dark:border-blue-500 bg-blue-100 dark:bg-blue-900 shadow-lg'
                    : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-blue-300 dark:hover:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-950'
                }`}>
                  {/* Header */}
                    ...
                    <div className="space-y-1 text-xs">
                      ...
                      {isCurrent && (
                        <div className="mt-2 pt-2 border-t border-blue-300 dark:border-blue-700">
                          <p className="font-bold text-blue-700 dark:text-blue-300 flex items-center gap-1 animate-pulse">
                  ...
                  {/* Hover hint para stages completados */}
      ...
      {/* Dica de Uso */}
      {onStageChange && (
        <div className="mt-2 mb-4 p-2 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg">
